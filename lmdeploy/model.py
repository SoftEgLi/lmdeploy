...
@MODELS.register_module(name="anygpt")
class AnyGPT(BaseChatTemplate):
    def __init__(self):
        super().__init__()
        print("loading AnyGPT Template")
    ...
    def messages2prompt(self, messages, sequence_start=True, **kwargs):
        # frontend has already done
        print(f"messages2prompt:{messages[0:30]}")
        return messages
