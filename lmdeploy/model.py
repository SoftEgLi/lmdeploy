...
""",
                system='<BOS><|im_start|>system\n',
                user='<|im_start|>user\n',
                assistant='<|im_start|>assistant\n',
                func_ret='<|im_start|>func_ret\n',
                func_call='<|im_start|>func_call\n',
                eosys='<|end_of_system|>\n',
                eoh='<|end_of_user|>\n',
                eoa='<|end_of_assistant|>\n',
                eofr='<|end_of_func_ret|>\n',
                eofc='<|end_of_func_call|>\n',
                separator='\n',
                stop_words=['<|end_of_moss|>'],
                **kwargs):
